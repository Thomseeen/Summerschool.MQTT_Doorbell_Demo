/*
 * User defined additionally needed defines
 * - for LWMQTT
 */
#define CONFIG_LWIP_SO_RCVBUF 1
/*
 * Experimental to improve stability
 */
#define CONFIG_USE_ONLY_LWIP_SELECT 1
#define CONFIG_LWIP_IP_FRAG 1
#define CONFIG_ESP32_WIFI_TX ESP32_WIFI_DYNAMIC_TX_BUFFER
...
#define CONFIG_TCP_SND_BUF_DEFAULT 21540
